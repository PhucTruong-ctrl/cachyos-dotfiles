            ...
            transitions: [
                Transition {
                    ...
                    SequentialAnimation {
                        NumberAnimation {
                            property: "opacity"
                            duration: Appearance.mediaReveal
        ...
        Row {
                    ...
                    delegate: Item {
                        ...
                        Rectangle {
                            readonly property real barVal: {
                                const idx = index * 2;
                                return (CavaService.bars && CavaService.bars.length > idx) ? CavaService.bars[idx] : 0;
                            }
            ...
            Item {
                ...
                Text {
                    ...
                    text: MediaService.title.length > 0 ? MediaService.title + " — " + MediaService.artist : MediaService.playerName
